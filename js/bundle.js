  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener("input", () => {
      if (input.value.match(/\D/g)) {
        input.style.background = "rgba(251, 21, 21, 0.8)";
...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getRecourse)("http://localhost:3000/menu").then((data) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getRecourse: () => (/* binding */ getRecourse),
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2023-09-10 9:00:00");
});
